...
//  Based on a matlab code by Zygmunt L. Szpak (c) 2012
{
	...
	S.numberOfPoints = (long)pts[0].size();
...
{
	long NumStrokes= (long)length.size();
...
//and flags of visitable dashed strokes are updated
{
	...
	long NumDashedStrokes= (long)DashedStrokes.size();
