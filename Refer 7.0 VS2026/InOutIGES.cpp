...
//The number of global lines printed is returned in numG
{
	...
	sprintf_s( CadenaAux, sizeof CadenaAux/sizeof *CadenaAux, "%*d", digits((long)sname.length()), (long)sname.length());
	std::string shortname= CadenaAux;    shortname+= "H";    shortname+= sname;

	global+= shortname;    global+= ",";

	//04 File name (we use the file name)
	sprintf_s( CadenaAux, sizeof CadenaAux/sizeof *CadenaAux, "%*d", digits((long)name.length()), (long)name.length());
...
//Parameter data for a composite curve (102)
{
	...
	sprintf_s( CadenaAux, sizeof CadenaAux/sizeof *CadenaAux, "%d", (long)pointerEntities.size());
	parameter+=",";
	parameter+= CadenaAux;
...
//Parameter data for surface boundary consisting of curves lying on a surface (141)
{
	...
	sprintf_s( CadenaAux, sizeof CadenaAux/sizeof *CadenaAux, "%d", (long)pointerCurves.size());
	parameter+=",";
	parameter+= CadenaAux;
...
//Parameter data for level (402_07)
{
	...
	//1 				INT 	N 	Number of entities
	sprintf_s( CadenaAux, sizeof CadenaAux/sizeof *CadenaAux, "%d", (long)pointerFacets.size());
	parameter+=",";
	parameter+= CadenaAux;
