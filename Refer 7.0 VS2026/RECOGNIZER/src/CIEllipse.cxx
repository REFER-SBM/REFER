...
CIPolygon *CIEllipse::calcEllipse(CIPoint *points)
{
    ...
    a = sqrt(pow((double)(points[2].x - points[1].x),2) + pow((double)(points[2].y - points[1].y),2)) / 2;  //pcompany2009
    b = sqrt(pow((double)(points[0].x - points[1].x),2) + pow((double)(points[0].y - points[1].y),2)) / 2;  //pcompany2009
    ...
    d2=pow((double)b,2)*pow((double)(x+1/2),2)+pow((double)a,2)*pow((double)(y-1),2)-pow((double)a,2)*pow((double)b,2);  //pcompany2009
    while(y>=-1) {
    	if(d2<0) {
