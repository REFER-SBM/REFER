...
void CDialogSettingsRefer::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_REFER_toolbarButtonsSize, m_toolbarButtonsSize);
	DDX_Text(pDX, IDC_REFER_PathINI, m_PathINI);
	DDX_Text(pDX, IDC_REFER_PathExamples, m_PathExamples);
...
// Produces local versions of those general parameters that can be modified by this dialog
{
	...
	m_toolbarButtonsSize = ReferApp.GeneralParams.toolbarButtonsSize;
	m_PathINI = ReferApp.GeneralParams.PathINI;
	m_PathExamples = ReferApp.GeneralParams.PathExamples;
}
...
// Updates the general parameters that have been modified in the dialog
{
	...
	ReferApp.GeneralParams.toolbarButtonsSize= m_toolbarButtonsSize;
	ReferApp.GeneralParams.PathINI = m_PathINI;
	ReferApp.GeneralParams.PathExamples = m_PathExamples;
}
