...
//and no alternative triplets are searched
{
	...
	do{
		...
		if (EvaluatedVerticesInFace.size() > 0){
			...
			i= (long)VerticesInFace.size()-2;  //No more first vertices will be tested
		...
		do{
			...
			if (EvaluatedVerticesInFace.size() > 1){
				...
				j= (long)VerticesInFace.size()-1;   //No more second vertices will be tested
			...
			do{
				...
				if (EvaluatedVerticesInFace.size() > 2){
					...
					k= (long)VerticesInFace.size(); //No more third vertices will be tested
					k1=-1;
				}
				else{
