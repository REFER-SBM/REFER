...
{
	long previous= (long)StrokePoints.size()-1;
...
//Corners (including endpoints) are stored in vector "StrokeCorners"
{
	...
	return ((long)StrokeCorners.size()-2);
}
...
{
	return (long)SketchStrokes.size();
}
