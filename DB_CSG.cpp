...
{
	return DatumPlanes.size();
}


void CDatums::AddDatumPlane(CDatumPlane InDatumPlane)
{
	InDatumPlane.SetIDDPlane(DatumPlanes.size());
...
{
	return CrossSectionVertices.size();
}
...
{
	return ParametricProfileCoorVertices.size();
}
